package com.example.fitness_tracker.config.db;

import com.example.fitness_tracker.config.DbProperty;
...
@EnableJpaRepositories(
        ...
        basePackages = {"com.example.fitness_tracker.repository"})
public class MasterdbConfig extends AbstractPoolConfiguration {

    @Bean("rawMasterDataSourceProperties")
    @ConfigurationProperties("db.fitness.datasource")
    @Primary
    ...
    public LocalContainerEntityManagerFactoryBean entityManager(EntityManagerFactoryBuilder entityManagerFactoryBuilder,
        ...
        return createEntityManagerFactory(entityManagerFactoryBuilder, dataSource, new String[]{"com.example.fitness_tracker.data"},
                "rawMaster");
    }
